    ...
    <div className="h-[100dvh] flex flex-col bg-background">
      <header className="flex-none h-16 border-b bg-card flex items-center px-6 justify-between shadow-sm z-10 sticky top-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl md:text-2xl font-bold tracking-tight">나고야 여행 플래너</h1>
            <p className="text-xs md:text-sm text-muted-foreground hidden sm:block">실시간 협업 중</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <a
            href="https://www.airbnb.co.kr/s/Nagoya--Japan/homes?tab_id=home_tab&refinement_paths%5B%5D=%2Fhomes&search_mode=flex_destinations_search&checkin=2026-04-10&checkout=2026-04-13&adults=4&source=structured_search_input_header&search_type=user_map_move"
            target="_blank"
          ...
          <a
            href="https://flight.naver.com/flights/international/PUS:airport-NGO:airport-20260410/NGO:airport-PUS:airport-20260413?adult=1&fareType=Y&isDirect=false"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://www.google.co.kr/maps/@35.1709,136.8815,15z?entry=ttu"
            target="_blank"
            rel="noopener noreferrer"
